...
def main():
    ...
    conversation_id = None  # Optionally specify a conversation ID or create a new one each time
    ...
    try:
        while True:
            ...
            chat_response = chat_client.create_chat_message(
                inputs={}, query=query, user=user_id, response_mode="blocking", conversation_id=conversation_id)
